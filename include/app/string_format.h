...
#define normal_s(text)      NORMAL + std::string(text) + RESET     // NORMAL text format macro
#define bold_s(text)        BOLD + std::string(text) + RESET       // BOLD text format macro
#define faint_s(text)       FAINT + std::string(text) + RESET      // FAINT text format macro
#define underline_s(text)   UNDERLINE + std::string(text) + RESET  // UNDERLINE text format macro
#define blink_s(text)       BLINK + std::string(text) + RESET      // BLINK text format macro
#define reversed_s(text)    REVERSED + std::string(text) + RESET   // REVERSED text format macro
#define concealed_s(text)   CONCEALED + std::string(text) + RESET  // CONCEALED text format macro

#define white_s(text)       WHITE + std::string(text) + RESET      // WHITE text format macro
#define lightgrey_s(text)   LIGHTGREY + std::string(text) + RESET  // LIGHTGREY text format macro
#define darkgrey_s(text)    DARKGREY + std::string(text) + RESET   // DARKGREY text format macro
#define black_s(text)       BLACK + std::string(text) + RESET      // BLACK text format macro
#define red_s(text)         RED + std::string(text) + RESET        // RED text format macro
#define lightred_s(text)    LIGHTRED + std::string(text) + RESET   // LIGHTRED text format macro
#define yellow_s(text)      YELLOW + std::string(text) + RESET     // YELLOW text format macro
#define lime_s(text)        LIME + std::string(text) + RESET       // LIME text format macro
#define green_s(text)       GREEN + std::string(text) + RESET      // GREEN text format macro
#define steelblue_s(text)   STEELBLUE + std::string(text) + RESET  // STEELBLUE text format macro
#define skyblue_s(text)     SKYBLUE + std::string(text) + RESET    // SKYBLUE text format macro
#define cyan_s(text)        CYAN + std::string(text) + RESET       // CYAN text format macro
#define blue_s(text)        BLUE + std::string(text) + RESET       // BLUE text format macro
#define purple_s(text)      PURPLE + std::string(text) + RESET     // PURPLE text format macro
#define mageta_s(text)      MAGETA + std::string(text) + RESET     // MAGETA text format macro
#define brown_s(text)       BROWN + std::string(text) + RESET      // BROWN text format macro

#define b_white_s(text)     B_WHITE + std::string(text) + RESET      // B_WHITE text format macro
#define b_lightgrey_s(text) B_LIGHTGREY + std::string(text) + RESET  // B_LIGHTGREY text format macro
#define b_darkgrey_s(text)  B_DARKGREY + std::string(text) + RESET   // B_DARKGREY text format macro
#define b_black_s(text)     B_BLACK + std::string(text) + RESET      // B_BLACK text format macro
#define b_red_s(text)       B_RED + std::string(text) + RESET        // B_RED text format macro
#define b_lightred_s(text)  B_LIGHTRED + std::string(text) + RESET   // B_LIGHTRED text format macro
#define b_yellow_s(text)    B_YELLOW + std::string(text) + RESET     // B_YELLOW text format macro
#define b_lime_s(text)      B_LIME + std::string(text) + RESET       // B_LIME text format macro
#define b_green_s(text)     B_GREEN + std::string(text) + RESET      // B_GREEN text format macro
#define b_steelblue_s(text) B_STEELBLUE + std::string(text) + RESET  // B_STEELBLUE text format macro
#define b_skyblue_s(text)   B_SKYBLUE + std::string(text) + RESET    // B_SKYBLUE text format macro
#define b_cyan_s(text)      B_CYAN + std::string(text) + RESET       // B_CYAN text format macro
#define b_blue_s(text)      B_BLUE + std::string(text) + RESET       // B_BLUE text format macro
#define b_purple_s(text)    B_PURPLE + std::string(text) + RESET     // B_PURPLE text format macro
#define b_mageta_s(text)    B_MAGETA + std::string(text) + RESET     // B_MAGETA text format macro
#define b_brown_s(text)     B_BROWN + std::string(text) + RESET      // B_BROWN text format macro
